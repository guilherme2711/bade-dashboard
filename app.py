...
SQL_GIRO = """
    ...
    WHERE TABEMP.ESTAB IN (1, 2, 3, 4, 5, 7)
      ...
      AND TABITENS.DESCRICAO NOT LIKE '%TENIS%'
      AND TABITENS.DESCRICAO NOT LIKE '%TÊNIS%'
      AND TABITENS.DESCRICAO NOT LIKE '%SAPATENIS%'
      AND TABITENS.DESCRICAO NOT LIKE '%SAPATÊNIS%'
      AND TABITENS.DESCRICAO NOT LIKE '%CALCADO%'
      AND TABITENS.DESCRICAO NOT LIKE '%CALÇADO%'
      AND TABITENS.DESCRICAO NOT LIKE '%SAPATO%'
    GROUP BY 
      TABITENS.CODPFABRIC,
      TABITENS.DESCRICAO,
      COR.DESCRICAO,
